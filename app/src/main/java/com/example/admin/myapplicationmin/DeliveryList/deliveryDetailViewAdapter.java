...
public class deliveryDetailViewAdapter extends BaseAdapter {
    // Adapter에 추가된 데이터를 저장하기 위한 ArrayList
    private ArrayList<DeliveryVO> listViewItemList = new ArrayList<DeliveryVO>() ;

    // ListViewAdapter의 생성자
    public deliveryDetailViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.detaillistveiw, parent, false);
        }

        // 화면에 표시될 View(Layout이 inflate된)으로부터 위젯에 대한 참조 획득
        TextView dateTextView = (TextView) convertView.findViewById(R.id.text_date) ;
        TextView loctionTextView = (TextView) convertView.findViewById(R.id.text_loction) ;
        ...
        loctionTextView.setText(DeliveryVO.getDelivery_location());
    ...
    public void addItem(String loction,String date) {


        DeliveryVO item = new DeliveryVO();

        item.setProcess_date(date);
        item.setDelivery_location(loction);
